/*
 * Class: GifEncoder
 * Description: A well documented Encoder class for saving/creating GIF file formats from Image or native 
 *              Bitmap objects using native libraries.
 *
 * Source: Bumpkit - https://github.com/DataDink/Bumpkit
 * Authors: Mark Greenwald - https://github.com/DataDink
 * URL: https://github.com/DataDink/Bumpkit/blob/master/BumpKit/BumpKit/GifEncoder.cs
 * Date Retrieved: 13-09-2023
 *
 * Note: The class has been adapted for use in ImAdjustr. Code comments are not my own.
 */
...
namespace ImAdjustr.Utility {
    ...
    public class GifEncoder : IDisposable {
        ...
        private void WriteGraphicControlBlock(Stream sourceGif, TimeSpan frameDelay) {
            ...
            WriteByte((blockhead[3] & 0xF8) | 0x01 | 0x04); // Setting disposal flag
